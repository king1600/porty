...
typedef union { double f64; int32_t i32; uint64_t u64; uintptr_t ptr; } pterm_t;
...
typedef struct { uint32_t idx; pterm_t key; pterm_t value; void* ptr; } pt_map_iter_t;
typedef pterm_t (*pt_func) (pt_actor_t* env, int argc, pterm_t* argv);
...
uint64_t pt_hash(pterm_t value);
